...
export PATH=$PATH:"$HOME/.local/bin:$HOME/.cargo/bin:/var/lib/flatpak/exports/bin:/.local/share/flatpak/exports/bin:/home/cipher/tooling/cursor/cursor-0.45.10-build-250205buadkzpea-x86_64.AppImage"
...
__conda_setup="$('/home/cipher/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/cipher/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/cipher/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/cipher/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
